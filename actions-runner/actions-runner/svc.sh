...
SVC_NAME="actions.runner.cce2955-rpi-terraform-deploy.raspberrypi.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (cce2955-rpi-terraform-deploy.raspberrypi)"
